...
const Toolkit = () => {
  const tools = [
    ...
    { name: "Kubernetes", icon: "https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/svg/kubernetes.svg" },
    ...
    { name: "Proxmox", icon: "https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/svg/proxmox.svg" },
  ];
